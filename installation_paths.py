...
def show_installation_paths():
    ...
    print(
        f"   📂 Python balíky:  {home}/MyCoder-v2.0/.venv/lib/python3.x/site-packages/"
    )
    ...
    print(
        f"   📂 Installed pkg:  {home}/MyCoder-v2.0/.venv/lib/python3.x/site-packages/claude_cli_auth/"
    )
    ...
    for dir_path in potential_dirs:
        ...
        print(
            f"   📂 {dir_path:<20} {'✅ existuje' if expanded.exists() else '⏳ vytvoří se při použití'}"
        )
