...
async def sharp_test():
    ...
    try:
        from mycoder import EnhancedMyCoder, MyCoder
        ...
        print(
            f"✅ Enhanced MyCoder inicializován v režimu: {mycoder.mode_manager.current_mode.value}"
        )
        ...
        try:
            ...
            await mycoder.mode_manager.transition_to_mode(
                mycoder.mode_manager.OperationalMode.RECOVERY, "Testing fallback"
            )
