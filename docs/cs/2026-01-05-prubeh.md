...
### CLI a spousteni
- Pridany entrypoint mycoder = cli_interactive:main v pyproject.toml.
...
- src/mcp_connector.py startuje lokalni MCP, kdyz orchestrator neni dostupny.
