        ...
        if 'thermal' in final_status:
            ...
            if hasattr(mycoder, 'get_thermal_history'):
                try:
                    ...
                    print(f"   Average Temp (last 10 min): {history.get('avg_temp_10m', 'N/A')}°C")
                    print(f"   Time above 75°C: {history.get('time_above_max', 0):.1f}s")
                except:
                    pass
...
async def thermal_integration_example():
    ...
    performance_script = Path("/home/milhy777/Develop/Production/PowerManagement/scripts/performance_manager.sh")
