...
- 2026-02-01: Codex - Adjusted config save/load to support env override flag, ensured permission errors are handled, and stabilized roundtrip behavior; tests run: `poetry run pytest tests/unit/ -v`, `poetry run pytest tests/providers/ -v`.
